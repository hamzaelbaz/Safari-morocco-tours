...
exports.handler = async function (event, context) {
    try {
        ...
        const { firstNames, messages, lastNames, emails, tele } = requestBody;

        console.log('Email details:', { firstNames, messages, lastNames, emails, tele });
...
Le nom : ${firstNames+" "+ lastNames} <br>Email : ${emails} <br> telephone : ${tele}  <br> Message : ${messages} <br>
</p>
